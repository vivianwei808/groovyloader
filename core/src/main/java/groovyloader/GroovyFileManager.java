 ...
 * 从路径加载
 */
public class GroovyFileManager {
    ...
    static GroovyFileManager INSTANCE;

    private GroovyFileManager() {
    }
    ...
    public static void init(int pollingIntervalSeconds, String... directories) throws Exception, IllegalAccessException, InstantiationException {
        if (INSTANCE == null) INSTANCE = new GroovyFileManager();
    ...
    public static GroovyFileManager getInstance() {
        return INSTANCE;
    }
    ...
    public File getDirectory(String sPath) {
        ...
        if (!directory.isDirectory()) {
            URL resource = GroovyFileManager.class.getClassLoader().getResource(sPath);
            try {
    ...
    void processGroovyFiles(List<File> aFiles) throws Exception, InstantiationException, IllegalAccessException {
        ...
        for (File file : aFiles) {
            XXXLoader.getInstance().putFilter(file);
        }
    }
